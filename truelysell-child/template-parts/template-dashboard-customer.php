					...
					<?php endif; ?>
                     ...
                     <?php if (!in_array($role, array('owner', 'seller'))) : ?>
						...
						if ($bookmarks_page) : ?>
							...
							<li id="<?php echo esc_html($role);?>" class="mb-4" ><a  href="<?php echo esc_url(get_permalink($bookmarks_page)); ?>" class="d-flex align-items-center <?php if ($post->ID == $bookmarks_page) : ?> active <?php endif; ?>"><i class="ti ti-heart me-2"></i> <?php esc_html_e('Favorites', 'truelysell'); ?></a></li>
